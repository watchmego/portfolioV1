    ...
    <div className="max-w-[1100px] py-10 items-center justify-center m-auto">
      <div className="flex gap-10 w-full  height-auto flex-col xl:flex-row  ">
        ...
        <p className="w-screen xl:w-[calc(50%-20px)] text-2xl tracking-wide leading-relaxed">
          I am a driven software engineer with 13 years of experience in the
          broader IT field. <br />I find simple solutions to solve problems
        </p>
        <p className="w-screen xl:w-[calc(50%-20px)] text-xl tracking-wide leading-relaxed">
          I'm an experienced techie with over 14 years experience in the field.
          Last year after selling my business last year I decided to move into
          Software Engineering. The rest of my time in IT has been spent in
          VOIP, Systems and Network Engineering so I have a wide ranging
          knowledge, and I've now topped it off with the ability to make things
          from scratch.
        </p>
      </div>
